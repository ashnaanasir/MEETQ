...
export const REGISTER_URL ="https://meetq.onrender.com/accounts/register/";
export const LOGIN_URL ="https://meetq.onrender.com/accounts/login/";
export const LOGOUT_URL ="https://meetq.onrender.com/accounts/logout/";
export const REFRESH_URL ="https://meetq.onrender.com/accounts/api/token/refresh/";
export const OBTAIN_TOKEN_URL ="https://meetq.onrender.com/accounts/api/token/";
export const PROFILE_URL ="https://meetq.onrender.com/accounts/profile/view/";
export const PROFILE_EDIT_URL ="https://meetq.onrender.com/accounts/profile/edit/";
export const CONTACTS_VIEW_URL ="https://meetq.onrender.com/accounts/api/contacts/";
export const ALL_CALENDARS_URL ="https://meetq.onrender.com/calendars/calendars/";
export const CALENDAR_DETAILS_URL ="https://meetq.onrender.com/calendars/calendars/<calendar_id>/";  // Replace <calendar_id> with actual ID when used
export const CREATE_CALENDAR_URL ="https://meetq.onrender.com/calendars/calendars/create/";
export const EDIT_CALENDAR_URL ="https://meetq.onrender.com/calendars/calendars/edit/<calendar_id>/";
export const GET_CALENDAR_INVITEES_URL = "https://meetq.onrender.com/calendars/calendars/<calendar_id>/invitees/"  // Replace <calendar_id> with actual ID when used
export const GET_CALENDAR_TIMES_URL = "https://meetq.onrender.com/calendars/calendars/<calendar_id>/timeslots/"  // Replace <calendar_id> with actual ID when used
export const GET_INVITEE_URL ="https://meetq.onrender.com/calendars/calendars/<calendar_id>/invitees/<invitee_id>/";  // Replace <calendar_id> and <invitee_id> with actual IDs when used
export const INVITE_RESPONSE_URL ="https://meetq.onrender.com/calendars/calendars/<calendar_id>/invitees/<invitee_id>/response/";  // Replace <invitee_id> with actual ID when used
export const SEND_INVITE_URL ="https://meetq.onrender.com/calendars/calendars/<calendar_id>/invitees/<invitee_id>/send_invite/";
export const CREATE_TIMESLOT_URL ="https://meetq.onrender.com/timeslot/create/";
...
// export const GET_CALENDAR_INVITEES_URL = "http://127.0.0.1:8000/calendars/calendars/<calendar_id>/invitees/"  // Replace <calendar_id> with actual ID when used
// export const GET_CALENDAR_TIMES_URL = "http://127.0.0.1:8000/calendars/calendars/<calendar_id>/timeslots/"  // Replace <calendar_id> with actual ID when used
...
// export const SEND_INVITE_URL ="http://127.0.0.1:8000/calendars/calendars/<calendar_id>/invitees/<invitee_id>/send_invite/";
